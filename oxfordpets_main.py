...
from oxfordpets_get_data import function_get_training_data_cc, input_cc, output_cc, function_normalise_data
from oxfordpets_get_data import input_data, function_get_input_data, classifier_data
from oxfordpets_get_data import function_reduce_dimension_of_data
from oxfordpets_train_cc import train_tf_cc_input, train_tf_cc_output, function_train_tensorflow_cc, function_train_keras_cc
from oxfordpets_train_cc import classifier_output, function_train_classifier_for_cc
print "*****************************************************************************************************************************************"
...
dataset_list = ['sample_wt', 'oxfordpets']
DATASET_INDEX = 1
system_list = ['desktop', 'laptop']
SYSTEM_INDEX = 0
#DATA_SAVE_PATH = '../data-stanford40/data14/'
DATA_SAVE_PATH = '/home/SharedData/omkar/study/phd-research/codes/tf-codes/data-oxfordpets/data2_hemachandra/'
...
if DATASET_INDEX == 0:
	...
	dimension_hidden_layer1_coder = 50#int(REDUCED_DIMENSION_VISUAL_FEATURE / 5)
	min_num_samples_per_class = 90 
