...
from oxfordpets_get_data import classifier_data
		...
		for i in range(n_rounds):
			...
			for batch in range(number_of_batches):
				...
				if batch % 1000 == 0:
					...
					print "Epoch %6d Batch %6d:  train MSE %f valid MSE %f" %(i, batch, sess.run(loss, feed_dict={x: obj_train_tf_cc_input.cc1_input_train_perm, y_:obj_train_tf_cc_input.cc1_output_train_perm}), \
					sess.run(loss, feed_dict={x: batch_x_valid, y_:batch_y_valid}))
