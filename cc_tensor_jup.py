...
from get_data_for_cc import function_reduce_dimension_of_data
...
#PCA
if 1:
	visual_features_dataset = function_reduce_dimension_of_data(visual_features_dataset_ori, REDUCED_DIMENSION_VISUAL_FEATURE)
else:
...
base_filename = DATA_SAVE_PATH + dataset_list[DATASET_INDEX] + str(dimension_hidden_layer1_coder) + '_' + str(REDUCED_DIMENSION_VISUAL_FEATURE) + '_'

exp_name = '_feat_fusion_clsfr_'
