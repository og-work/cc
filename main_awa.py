...
DATA_SAVE_PATH = '/home/SharedData/omkar/study/phd-research/codes/tf-codes/data-zsl/data-awa/data2/'
...
for classI in test_class_labels:
	...
	if cnt == 0:
		...
		obj_classifier.test_attributes = attributes[classI - 1, :]
	...
	if not os.path.isfile(filename):
		...
		for classJ in train_class_labels:
			if (classI != classJ):
				...
				#obj_classifier.train_attributes_cross = train_attributes_cross
				#obj_classifier.valid_attributes_cross = valid_attributes_cross
				#obj_classifier.test_attributes_cross = test_attributes_cross
...
obj_classifier.test_attributes_cross = np.zeros((obj_classifier.test_attributes.shape), float)
...
#string_title = 'Combined attributes (Seen classes-test)'
#file_title = 'combined_attr_test'
...
for seen_class in train_class_labels:
	for unseen_class in test_class_labels:
		...
		train_attributes_cross_mapped, valid_attributes_cross_mapped, test_attributes_cross_mapped = train_seen_to_unseen_regressor(obj_classifier, seen_class, unseen_class)
...
#string_title = 'Seen to unseen classes mapping test'
#file_title = 'seen_to_unseen_test'
